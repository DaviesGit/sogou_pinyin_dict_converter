...
const size_t kMaxSpellingNum = 8192 - kHalfSpellingIdNum - 1;
...
const LemmaIdType kSysDictIdEnd = 3000000;

// The first lemma id for the user dictionary.
const LemmaIdType kUserDictIdStart = 3000001;

// The last lemma id (included) for the user dictionary.
const LemmaIdType kUserDictIdEnd = 3100000;
